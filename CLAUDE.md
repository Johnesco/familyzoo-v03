# Family Zoo — v03 — Scenery — Claude Project Memory
...
**Name:** Family Zoo — v03 — Scenery
**Purpose:** Sharpee tutorial step 3 — Scenery.
...
**Repository:** https://github.com/Johnesco/familyzoo-v03
**Live:** https://johnesco.github.io/familyzoo-v03/
...
├── familyzoo-03.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v03.story`.
